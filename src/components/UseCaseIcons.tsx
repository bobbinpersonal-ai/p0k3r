...
export function BuildingIcon() {
  return (
    <svg viewBox="0 0 64 64" className="h-10 w-10" aria-hidden="true">
      ...
      <rect x="20" y="14" width="8" height="8" fill="#bff7ff" opacity="0.6" />
      <rect x="36" y="14" width="8" height="8" fill="#bff7ff" opacity="0.6" />
      <rect x="20" y="28" width="8" height="8" fill="#bff7ff" opacity="0.6" />
      <rect x="36" y="28" width="8" height="8" fill="#bff7ff" opacity="0.6" />
...
export function TVIcon() {
  return (
    <svg viewBox="0 0 64 64" className="h-10 w-10" aria-hidden="true">
      ...
      <rect x="12" y="16" width="40" height="22" rx="2" fill="#bff7ff" opacity="0.5" />
...
export function BikeIcon() {
  return (
    <svg viewBox="0 0 64 64" className="h-10 w-10" aria-hidden="true">
      <circle cx="16" cy="46" r="10" fill="none" stroke="#22d3ee" strokeWidth="3" />
      <circle cx="48" cy="46" r="10" fill="none" stroke="#22d3ee" strokeWidth="3" />
      <path
