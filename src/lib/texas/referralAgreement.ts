...
//
// Not legal advice. See docs/texas-contracts.md.
  ...
  const sections: ContractSection[] = [
    ...
    },
    {
      ...
      body:
        ...
        "Rule, the national and Texas do-not-call registries, and Texas law on telephone " +
        "solicitation. The Marketer indemnifies the Contractor against any claim arising from " +
        "how the Marketer contacted somebody.\n\n" +
    ...
    },
    {
      ...
      body:
        `Texas law governs. Notice to the Marketer goes to ${SELLER.name}, ${sellerAddress()}. ` +
